...
public class AnswerAdapter extends ArrayAdapter<Answer> {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder.setAnswerText((EditText) newView.findViewById(R.id.edit_answerText));
            ...
            holder.getAnswerText().addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    /*
                     * We need to check if the quiz question is valid and if so we must enable the submit button. The
                     * problem here is currently there is no way to access the submit button from here.
                     */
                }
            });
            ...
            holder.getCheckButton().setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (isChecked >= 0) {
                        getItem(isChecked).setChecked(activity.getResources().getString(R.string.heavy_ballot_x));
                    }
                    isChecked = position;
                    getItem(position).setChecked(activity.getResources().getString(R.string.heavy_check_mark));
            ...
            holder.getRemoveButton().setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (AnswerAdapter.this.getCount() > 1) {
                        ...
                        Toast.makeText(activity, "A question without an answer is useless, isn't it?",
