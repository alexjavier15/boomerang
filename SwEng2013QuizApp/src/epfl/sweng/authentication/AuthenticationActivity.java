...
public class AuthenticationActivity extends Activity implements HttpcommunicationsAdapter {
   ...
   // private static final int MAX_NUMBER_OF_FAILS = 3;
    ...
    private HttpResponse requestAuthToken(HttpResponse starter) throws ClientProtocolException, IOException, NetworkErrorException {
    ...
    private HttpResponse postTequilaToken(HttpResponse tokenResponse) throws JSONException, IOException, NetworkErrorException {
