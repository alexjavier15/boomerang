...
public class QuizQuestionDBHelper extends SQLiteOpenHelper implements BaseColumns {
    ...
    public void addQuizQuestion(String question) {
        ...
        try {
            values.put(COLUMN_NAME_TAGS, Arrays.toString((new QuizQuestion(question)).getTags().toArray()));
    ...
    public List<String> getQueriedQuestions(JSONObject query) throws UnsupportedOperationException {
        ...
        Cursor cursor = db.query(true, TABLE_NAME, new String[] {_ID, COLUMN_NAME_JSON_QUESTION}, selection,
