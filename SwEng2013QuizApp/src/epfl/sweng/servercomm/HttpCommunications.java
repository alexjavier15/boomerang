...
<<<<<<< HEAD
    ...
    public static HttpResponse postQuestion(String url, JSONObject question) throws ClientProtocolException,
        ...
        HttpResponse response = SwengHttpClientFactory.getInstance().execute(post);

        return response;
    }

    public static HttpResponse post(String url, HashMap<String, String> postParametters) throws JSONException,
            ClientProtocolException, IOException {
        JSONObject jsonPost = new JSONObject(postParametters);
        Debug.out("json" +jsonPost.toString());
        HttpPost post = new HttpPost(url);
        post.setEntity(new StringEntity(jsonPost.toString(STRING_ENTITY)));
        post.setHeader("Content-type", "application/json");
