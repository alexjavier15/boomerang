...
import epfl.sweng.MainActivity.MainActivityTemplate;
...
public class TestLogInLogOutTest extends MainActivityTemplate {

    @Override
    protected void setUp() throws Exception {
        super.setUp();
        MockHttpClient mock = new MockHttpClient();
        mock.pushCannedResponse("POST https://sweng-quiz.appspot.com/quizquestions/ HTTP/1.1", HttpStatus.SC_CREATED,
